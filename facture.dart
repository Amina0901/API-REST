...
import 'package:flutter_application_fiin/main.dart';
import 'listerfacture.dart';
...
class fatures extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
           color: Color.fromARGB(255, 238, 192, 238),
        child: Column(
          children: [
            Container(
              ...
              child: ListTile(
                ...
                onTap: () {
                    Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => listefacture ()),
                  );
                },
              ),
            ),
